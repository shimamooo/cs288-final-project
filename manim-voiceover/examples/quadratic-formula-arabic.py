...
RESOLUTION = ""
FLAGS = (
    "-pqk -o ar_formule_quadratique_logo2 --disable_caching"  # "-pql --fps 10 -n 39 "
)
...
class QuadraticFormulaArabic(VoiceoverScene):
    def construct(self):
        ...
        er = 0.2
        eq14 = MathTex(r"\Delta = ", r"{b^2 -4ac} ", font_size=fs).to_edge(DOWN)
